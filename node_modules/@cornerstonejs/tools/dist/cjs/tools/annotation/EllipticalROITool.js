        ...
        this._calculateCachedStats = (annotation, viewport, renderingEngine, enabledElement) => {
            ...
            for (let i = 0; i < targetIds.length; i++) {
                ...
                if (this._isInsideVolume(worldPos1Index, worldPos2Index, dimensions)) {
                    ...
                    const pointsInShape = (0, utilities_1.pointInShapeCallback)(imageData, (pointLPS, pointIJK) => (0, ellipse_1.pointInEllipse)(ellipseObj, pointLPS), this.configuration.statsCalculator.statsCallback, boundsIJK);
